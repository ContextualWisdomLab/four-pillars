"""Call Contextual Orchestrator through the provider-neutral infrastructure ACL."""
...
ContextualOrchestratorError = OrchestrationTransportError
ContextualOrchestratorSchemaError = OrchestrationSchemaError


class ContextualOrchestratorClient(OpenAICompatibleJsonClient):
        ...
        *,
        ...
        if not settings.contextual_orchestrator_token:
            raise ContextualOrchestratorError(
                "CONTEXTUAL_ORCHESTRATOR_TOKEN is required for report interpretation"
            )
        ...
        super().__init__(
            ...
            max_schema_repairs=settings.contextual_orchestrator_max_schema_repairs,
            service_label="Contextual Orchestrator",
