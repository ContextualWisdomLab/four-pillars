...
- CLI options for explicit birthplace longitude and civil, mean-solar, or apparent-solar time policy, with a Bucheon 1990 regression proving the corrected time rounds to 07:57 while remaining in the same `壬辰` hour pillar.
