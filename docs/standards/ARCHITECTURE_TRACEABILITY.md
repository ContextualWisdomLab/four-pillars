...
| Work-conserving autonomous development | PRD 4.9; TRD 14 | ADR 0007; AUTONOMOUS_DEVELOPMENT | minute-47 product-dev control; exact-head governance | PR #29 steward remains `active_pr` until merged |
...
| Architecture claims distinguish shipped vs planned | PRD 4.9; TRD 16 | ADR 0005; DOCUMENTATION_AUDIT | documentation architecture contract test | root overlapping docs must sync after PR #29 |
