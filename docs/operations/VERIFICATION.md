...
2. **Deterministic behavior:** committed golden charts, Li Chun annual boundaries, `jie` monthly boundaries, daewoon direction, time policy, and lunar conversion tests pass.
