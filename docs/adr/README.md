...
| [0002-nvidia-nim.md](0002-nvidia-nim.md) | Accepted; extended by 0003 | Direct NVIDIA NIM is the standalone LLM generation/evaluation backend; `NVIDIA_NIM_API_KEY` is its credential. | `nim.py`, settings, hosted/offline NIM tests |
